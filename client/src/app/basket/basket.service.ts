...
export class BasketService {
  ...
  addItemToBasket(item: Product | BasketItem, quantity = 1) {
    if (this.isProduct(item)) item = this.mapProdductItemToBasket(item);
    //const itemToAdd = this.mapProdductItemToBasket(item);
  ...
  private mapProdductItemToBasket(item: Product): BasketItem {
    return {
      id: item.id,
      name: item.name,
      price: item.price,
